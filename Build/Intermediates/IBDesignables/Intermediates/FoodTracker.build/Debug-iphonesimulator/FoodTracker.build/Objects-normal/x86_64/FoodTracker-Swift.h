...
- (nullable instancetype)initWithName:(NSString * _Nonnull)name photo:(UIImage * _Nullable)photo rating:(NSInteger)rating OBJC_DESIGNATED_INITIALIZER;
...
- (IBAction)returnMenu:(UIStoryboardSegue * _Nonnull)segue;
- (void)read;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface UIColor (SWIFT_EXTENSION(FoodTracker))
...
@property (nonatomic, weak) IBOutlet RatingControl * _Null_unspecified ratingControl;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified cafeImage;
